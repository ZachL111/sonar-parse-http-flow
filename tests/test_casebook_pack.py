"""Regression checks for the sonar-parse-http-flow casebook."""
...
from casebook.harness import assert_expected, sonar_parse_http_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_parse_http_flow_summary(), assert_expected())
