...
$repo = "sonar-parse-http-flow"
$language = "Ruby"
$category = "Parsers"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/sonar-parse-http-walkthrough.md")) {
...
if ($hold -ne 1) { throw "$repo hold lane count changed" }
